...
const ProductRatingSection = ({ orderById, productRatings, isProductRated, setSelectedItem, setShowConfirmationModal, item }) => {
        ...
        <>
		  ...
		  <Col xs={9}>
                     ...
                     <div className="d-flex justify-content-between">
                      ...
                      <span>
                                                    <Button variant="secondary" className="p-0 lh-1 ms-2" disabled>
                            Sudah Dinilai
                          </Button>
