...
const ModalCompleted = ({ isOpen, onClose, courierOrderById }) => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      formData.append("note", "Pesanan diterima Oleh yang bersangkutan");
      formData.append("availability", "ready");
      formData.append("delivery_receipt_photo", file); // Kirim file gambar
  ...
  return (
    <div className={`modal-1-overlay ${isOpen ? "open" : ""}`}>
      <div className="modal-1-modal">
        ...
        <Card.Body>
          <p>
            Pastikan anda telah mengantar pesanan ke Orang yang tepat dan sesuai dengan pesanan {" "}
