...
// import { id } from 'date-fns/locale';
// import "./style.css";
// import { ArrowBigRight, MessageCircleMore } from 'lucide-react';
...
// 		</div>
//     <p>{seller.sellerInfo.address}</p>
//     </span>
//                         </div>
                        
                        
                        
//                         <DetailModal seller={seller}  show={showConfirmationModal}
//     onHide={() => setShowConfirmationModal(false)} />
//                       </Card.Header>
//                         <Card className='text-start p-3 lh-1'>
//                           <button   onClick={() => {
//     setShowConfirmationModal(true); 
//   }}>
//                           <div className='d-flex justify-content-between mb-3 lh-1 border-bottom'>
//                             <span>
//                           <p>Detail Pesanan</p>
//                           <h3>#{courierOrderById.order_code}</h3>
//                           </span>
//                           <span>
//                               <ArrowBigRight />
...
import { id } from 'date-fns/locale';
import "./style.css";
import { ArrowBigRight, ChevronRight, MessageCircleMore, MessageSquareMore } from 'lucide-react';
import useChatStore from '../../store/useChatStore';
import ContainerChat from './ContainerChat';
...
function CourierOrderDetail() {
  ...
  return (
    <>
        ...
        <Card>
          <Card.Body>
            ...
            <div className="datetime-group mb-5">
              ...
              <div className=' w-100 text-start p-3 mt-3 mb-3'>
                        <button className='w-100' onClick={() => setShowConfirmationModal(true)}>
                          <div className='d-flex justify-content-between align-items-center mb-3 lh-1 border-bottom'>
                            <span>
                              <strong className='text-start mb-2'>Detail Pesanan</strong>
                              <h3>#{courierOrderById.order_code}</h3>
                            </span>
                            <span className=''>
                              <ChevronRight />
                          ...
                          <div className="d-flex justify-content-between">
                            <span className='d-flex align-items-center'>
                              <img
                                ...
                                className="img-fluid rounded product-image"
                              />
                              <h3 className='fw-bold'>{seller.sellerInfo.name}</h3>
                            </span>
                            {/* <Col xs={7}>
                              <h6>{item.name}</h6>
                              <div className="text-muted">
      ...
      />
                ...
                <div className="p-3 border-top">
                  <Row className="text-start">
                    <Col>
                      <p className="mb-1">
                        Bayar tunai di restoran: Rp{getOrderSummary(courierOrderById).subtotal.toLocaleString('id-ID')}
                      </p>
                    </Col>
                  </Row>
                </div>
      ...
      <FooterButtons courierOrderById={courierOrderById} />
    </>
  );
}
