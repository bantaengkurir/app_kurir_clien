...
import ModalRating from "../../components/RatingModal";
...
const index = () => {
  ...
  const handleCancelOrder = (orderId) => {
    ...
    alert("pesanan berhasil di batalkan")
      ...
      alert("anda tidak dapat melakukan pembatalan produk")
    }
  };
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        {
          orders.status !== "cancelled" ? (<div className="d-flex justify-content-center ">
            <button
            ...
            >
              ...
              onClick={toggleModal}
              // onClick={() => navigate(`/orderdetail/${order.id}`)}
              className="btn w-50 mb-3 rounded-pill px-3 text-primary btn-md rounded-circle bg-light border mt-4 me-3 ms-3"
            >
              Selesai
            </button>
               ...
               <ModalRating isOpen={isOpen} toggleModal={toggleModal}/>
