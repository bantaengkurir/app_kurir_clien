...
//       navigate("/login"); // Atau arahkan ke halaman yang sesuai
//     }
//   }, [fetchProductSeller, token, navigate]);
...
const Index = () => {
  const { productSeller, fetchProductSeller, deleteProduct } = useProductStore();
  const navigate = useNavigate();
  const token = localStorage.getItem("token");
  ...
  console.log("Products:", productSeller); // Cek apakah produk tersedia dan sesuai kategori
      ...
      <div className="tab-content container mt-3 mb-3">
        <div className="text-end">
          <ul className="nav nav-pills text-center mb-5">
            ...
            <div
                  className="d-flex justify-content-end w-50 align-items-start">
                    ...
                    <div className="rounded position-relative fruite-product border border-secondary">
                      ...
                      <div className="d-flex justify-content-center">
                        ...
                        <button
                          ...
                          className="btn border border-secondary rounded-pill px-3 text-primary ms-2 me-2 mb-3"
                        >
                          <i className="fa-solid fa-pen-to-square text-success fs-3"></i>
                        </button>
                      </div>
                    </div>
                  </div>
