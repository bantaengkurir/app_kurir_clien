...
const Index = () => {
    ...
    const [category_id, setCategory_id] = useState(""); // Menyimpan ID kategori
      ...
      const fetchProductData = async () => {
        try {
          ...
          if (productData) {
            ...
            setCategory_id(productData.category_id || ""); // Gunakan category_id dari data produk
    ...
    const handleUpdate = async (e) => {
      ...
      formData.append("category_id", category_id); // Sertakan category_id dalam formData
