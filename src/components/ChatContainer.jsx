...
const ChatContainer = () => {
  ...
  // // Ambil theme dari localStorage dengan penanganan error
  // let theme = "light"; // Nilai default
  // let themeChat = "dark"; // Nilai default

  // try {
  //   const storedTheme = localStorage.getItem("chat-theme");
  //   if (storedTheme) {
  //     const parsedTheme = JSON.parse(storedTheme);
  //     theme = parsedTheme.theme || theme;
  //     themeChat = parsedTheme.themeChat || themeChat;
  //   }
  // } catch (error) {
